...
function TheCycle({ fadeInViewProps }: Props) {
  ...
  let spiralScrollValues = [0.37, 0.78];
  let scrollValues1 = [0.37, 0.4, 0.73, 0.75];
  let scrollValues2 = [0.37, 0.4, 0.43, 0.45];
  let scrollValues3 = [0.43, 0.45, 0.48, 0.5];
  let scrollValues4 = [0.48, 0.5, 0.53, 0.55];
  let scrollValues5 = [0.53, 0.55, 0.58, 0.6];
  let scrollValues6 = [0.58, 0.6, 0.63, 0.65];
  let scrollValues7 = [0.63, 0.65, 0.68, 0.7];
  let scrollValues8 = [0.68, 0.7, 0.73, 0.75];
  ...
  if (window.innerWidth <= 1226) {
    ...
    spiralScrollValues = [0.39, 0.79];
    scrollValues1 = [0.39, 0.43, 0.74, 0.76];
    scrollValues2 = [0.39, 0.41, 0.44, 0.46];
    scrollValues3 = [0.44, 0.46, 0.49, 0.51];
    scrollValues4 = [0.49, 0.51, 0.54, 0.56];
    scrollValues5 = [0.54, 0.56, 0.59, 0.61];
    scrollValues6 = [0.59, 0.61, 0.64, 0.66];
    scrollValues7 = [0.64, 0.66, 0.69, 0.71];
    scrollValues8 = [0.69, 0.71, 0.74, 0.76];
  ...
  if (window.innerWidth <= 814) {
    ...
    spiralScrollValues = [0.4, 0.78];
    scrollValues1 = [0.4, 0.42, 0.75, 0.78];
    scrollValues2 = [0.4, 0.42, 0.45, 0.47];
    scrollValues3 = [0.45, 0.47, 0.5, 0.52];
    scrollValues4 = [0.5, 0.52, 0.55, 0.57];
    scrollValues5 = [0.55, 0.57, 0.6, 0.62];
    scrollValues6 = [0.6, 0.62, 0.65, 0.67];
    scrollValues7 = [0.65, 0.67, 0.7, 0.72];
    scrollValues8 = [0.7, 0.72, 0.75, 0.77];
