    ...
    <PageContainer key="Birthing Wisdom Page">
      ...
      <SectionFrame key="Foreword">
        <SectionTextContainer>
          <h3>Foreword</h3>
          <p>
            Birthing Wisdom is a journey of soul initiation for women travelling
            the transition from menopause into elderhood. Whether in the early
            days of your midlife metamorphosis or in the middle of your
            menopausal years, this course provides you with a{" "}
            <b>
              <i>structure</i>
            </b>{" "}
            to{" "}
          ...
          <p>
            While this course shares themes and practices that are similar to my
            one-to-one sessions, Transformative Mentoring, what makes it
            distinct is that this is a structured program, designed to be shared
            with a community of women as they travel the path of their Midlife
            Rebirth.
          </p>
          <p>
      ...
      >
        <SectionTextContainer>
          ...
          <p className="white">
            ...
            The soulful ones beg for our attention too. In fact, many of us walk
            this transition alone. We should change that.
          </p>
          <p className="white">
          ...
          <p className="white">
            ...
            identity as a Woman of Wisdom. You’re already doing it. Diving deep
            into your inner landscape, looking for clues about your authentic
            self and your soul’s purpose. 
          </p>
          <p className="white">
            Growth and rebirth—they don’t happen in a straight line. It’s always
            a circle. The transition from menopause to your wisdom years is no
            different. This is a journey of circumambulation: a “walk around”
            something holy and sacred. A “circle around” you. A pilgrimage. 
          </p>
          <p className="white">
      ...
      <SectionFrame>
        <SectionTextContainer key="what is Birthing Wisdom?">
          ...
          <p>
            Menopause changes us on both the cellular and soulful level. It’s a
            time where we let go of what is dying to make room for the emergence
            of something new. Birthing Wisdom is a structured course designed to
            guide women on their pilgrimage to self, build a relationship with
            soul, and find purpose. This course is run for a group of women,
            offering a communal space to process this journey. 
          </p>
          <p>
            ...
            identified these psychological-spiritual steps for the journey into
            wise elderhood. These steps heavily inform this course. 
          </p>
      ...
      <SectionFrame key="your journey">
        <SectionTextContainer>
          ...
          <p>
            Birthing Wisdom is a course with two-fold intentions. It is an inner
            journey in which a woman births her Wise Woman Elder. It is also a
            collective of women who support each other on this journey to
            rebirth. By marrying these two intentions we find something the
          ...
          <p>
            ...
            for a one-on-one mentoring session. The time in between sessions is
            for personal reflection, soul practices, and creative expression.
          </p>
      ...
      >
        <SectionTextContainer>
          ...
          <p className="white">
            ...
            women on your course, you may find that your journey to soul and the
            shape of your return is different from your sisters. But Birthing
            Wisdom will provide you with the same structured guidance as you
            walk the winding path to your own soul encounter. The course has
            four stages: Preparation, Dissolution, Soul Encounter, and Return.
          </p>
          <Box style={{ padding: "10px", background: "var(--Primary-Light)" }}>
            <BoxInnerRoundedHalf style={{ borderColor: "var(--Primary-Dark)" }}>
              <RoundedHalfInnerTop>
      ...
      >
        <SectionTextContainer>
          ...
          <p className="white">
            ...
            an internet connection, a journal, and art supplies of your choice.
            You will receive the Zoom link to join our call ahead of time.
          </p>
          <p className="white">
            <b>
            ...
            note that this journey involves an 8-hour Soul Quest out in nature.
          </p>
          <p className="white">
            <b>
            ...
            <br />
            Some effective ways to prepare for this journey are to spend time in
            nature, support and nourish your body, deepen your personal
            relationships, engage in quiet contemplative practices, read
            mythology, and be creative.
            <br />
            <br />
            This program is for those who maintain a level of stability in their
            lives, are committed to fostering wellness, and are open to
          ...
          <p className="white">
            <b>
              <i>
                ...
                addiction, severe untreated trauma, or untreated mental illness.{" "}
              </i>
            </b>
            If uncertain about your readiness, I recommend working with a coach
            or therapist for a time before embarking on this journey.
          </p>
        </SectionTextContainer>
      </SectionFrame>
          ...
          <ButtonDiv>
            <SmallBox>
              ...
              <ul>
                ...
                <li>
                  In person or online. £1800 (This is a one-time special launch
            ...
            <SmallBox>
              ...
              <p>
                ...
                <br />
                <br />
                Contact me if you would like to book a private course, just for
                your and your sisters.
              </p>
              <Link to={"/transformative-mentoring"} className="primary-button">
                <p>Book now</p>
              </Link>
